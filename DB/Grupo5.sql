...
-- -----------------------------------------------------
-- Table `Grupo5`.`Producto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Grupo5`.`Producto` (
...
CREATE TABLE IF NOT EXISTS `Grupo5`.`Inventario` (
  ...
  INDEX `fk_Inventario_Producto_idx` (`idPro` ASC),
  CONSTRAINT `fk_Inventario_Producto`
    FOREIGN KEY (`idPro`)
    REFERENCES `Grupo5`.`Producto` (`idProducto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Grupo5`.`Local` (
  ...
  `idBod` INT NOT NULL,
  PRIMARY KEY (`idLocal`),
  INDEX `fk_Local_Inventario1_idx` (`idInv` ASC),
  INDEX `fk_Local_Gerente1_idx` (`idGer` ASC),
  INDEX `fk_Local_Bodeguero1_idx` (`idBod` ASC),
  CONSTRAINT `fk_Local_Inventario1`
    FOREIGN KEY (`idInv`)
    REFERENCES `Grupo5`.`Inventario` (`idInventario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
